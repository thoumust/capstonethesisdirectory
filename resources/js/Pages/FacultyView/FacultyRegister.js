...
import "../StudentView/StudentRegister.css";
...
const FacultyRegister = () => {
  ...
  const [formValues, setFormValues] = useState({
    ...
    password: "",
    confirmPassword: "",
    program: "", // New state for the selected program
  });
  ...
  return (
    <div className="register-container">
      <div className="register-content">
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            >
              ...
              <option value="CS">Computer Sciences (CS)</option>
        ...
        <a href="/faculty-login" onClick={handleReturnToLogin} className="return-login-link">
          Return to Login
        </a>
