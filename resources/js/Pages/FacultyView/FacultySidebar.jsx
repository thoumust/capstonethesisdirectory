...
const FacultySidebar = () => {
  ...
  return (
    <nav className="bg-[#A4231C] text-white w-64 h-screen fixed top-0 left-0 z-50 flex flex-col justify-between">
      <ul className="mt-6 space-y-4">
        ...
        <li className="pl-6">
          <div
            className="flex items-center space-x-3 cursor-pointer hover:bg-[#A62F2B] p-2 rounded-md"
          ...
          {isIPDropdownOpen && (
            <ul className="ml-10 mt-2 space-y-2">
              <li>
                <Link href="/faculty/ip-registered/IT-cap" className="block hover:text-gray-200">
                  IT Capstones
                </Link>
              </li>
              <li>
                <Link href="/faculty/ip-registered/IS-cap" className="block hover:text-gray-200">
                  IS Capstones
                </Link>
              </li>
              <li>
                <Link href="/faculty/ip-registered/CS-thes" className="block hover:text-gray-200">
                  CS Thesis
                </Link>
              </li>
            </ul>
      ...
      <div className="pl-6 pb-8">
        <a href="/faculty/profile" className="flex items-center space-x-3 hover:bg-[#A62F2B] p-2 rounded-md">
